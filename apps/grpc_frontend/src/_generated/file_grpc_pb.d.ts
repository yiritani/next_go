...
interface IFileServiceService
  extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  listFiles: IFileServiceService_IListFiles;
}

interface IFileServiceService_IListFiles
  extends grpc.MethodDefinition<
    file_pb.ListFilesRequest,
    file_pb.ListFilesResponse
  > {
...
export interface IFileServiceServer extends grpc.UntypedServiceImplementation {
  listFiles: grpc.handleUnaryCall<
    file_pb.ListFilesRequest,
    file_pb.ListFilesResponse
  >;
}
...
export interface IFileServiceClient {
  listFiles(
    request: file_pb.ListFilesRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: file_pb.ListFilesResponse,
    ) => void,

...
interface IPingServiceService
  extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ping: IPingServiceService_IPing;
}

interface IPingServiceService_IPing
  extends grpc.MethodDefinition<ping_pb.PingRequest, ping_pb.PingResponse> {

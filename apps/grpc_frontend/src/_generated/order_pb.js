...
proto.file.ListOrdersResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.file.ListOrdersResponse.repeatedFields_, null);
};
...
proto.file.ListOrdersResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.file.Order.toObject, includeInstance)
  };
 ...
 * @return {!proto.file.Order}
 */
proto.file.ListOrdersResponse.prototype.addOrders = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.file.Order, opt_index);
};

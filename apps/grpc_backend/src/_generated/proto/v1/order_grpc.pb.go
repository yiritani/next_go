...
const (
	OrdersService_ListOrders_FullMethodName  = "/api.v1.order.OrdersService/ListOrders"
	OrdersService_CreateOrder_FullMethodName = "/api.v1.order.OrdersService/CreateOrder"
)
...
var OrdersService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1.order.OrdersService",
